            ...
            <div class="card mb-4 rounded-2 shadow-sm border-primary" >
                <div class="card-body" style="background-color: #6a737d;">
                    <ul class="list-unstyled mt-3 mb-4">
                        ...
                        <textarea name="surname" class="form-control input-block">${user.surname}</textarea>
                        <label style="color: #f6f8fa">
                            Имя
                        </label>
                        <textarea name="name" class="form-control input-block">${user.name}</textarea>
                        <label  style="color: #f6f8fa">
                            Возраст
                        </label>
                        <textarea name="age" class="form-control input-block">${user.age}</textarea>
                        <label style="color: #f6f8fa">
                            Должность
                        </label>
                        <textarea name="post" class="form-control input-block">${user.post}</textarea>
                    </ul>
                    <button type="submit" name="commit" class="btn btn-primary btn-block">Изменить</button>
